    ...
    <div class="container col-md-5 col-md-offset-3">
        <div class="well well bs-component">
            ...
            <form class="form-horizontal" method="post">
                ...
                <fieldset>
                    <legend><b><font color="red">Add more details about your church!</font></legend>
                    Church details</b>
                    <div class="form-group">
                        <label for="name" class="col-lg-3 control-label">Church Name</label>
                        <div class="col-lg-7">
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label><input type="checkbox" value="">Allow google to capture location:</label>
                        </div>
                    </div>
